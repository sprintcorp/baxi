                          ...
                          <div class="row">
                            <div class="col-md-12">
                                <div class="row border-2 mt-1">
                                  <div class="col-md-4 mt-2 font-weight-bold"> Notification</div>
                                ...
                                <Loading v-if="!notification.length && loading">Loading...</Loading>
                                <div class="card mt-5" v-if="!notification.length && !loading">
